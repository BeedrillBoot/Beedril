module.exports = {
	...
	commandFunction: function (Bot, by, args, client) {
		if (!args[0]) return Bot.pm(by, 'I\'m a Bot by Beedril Hunter. If you have any issues regarding me, please contact them. To see my usable commands, use ``' + prefix + 'commands`` in a chatroom.');
